...
> 2026-09-25 最新：四群正常交談與譯文已另行啟用品質採集，並新增管理者私訊 /翻譯錯誤；本文件的「不保存」指不新增 lineTranslationFailures，四群 lineTranslationMessages 依 [品質紀錄與回報](DEV翻譯品質紀錄與錯誤案例回報.md) 保存，既有失敗集合規格不變。
