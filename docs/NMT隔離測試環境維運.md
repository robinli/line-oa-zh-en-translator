...
> **最新 dev 部署（2026-09-25）：** 已更新為 `linewebhook-00005-win`（ACTIVE、100% 流量），四群品質採集於台北時間 19:51:20 啟用，管理者私訊可 /翻譯錯誤；最近部署後檢查帳本為 25,568 字元／199 次，本次付費翻譯測試 0 字元。詳見 [品質紀錄與回報](DEV翻譯品質紀錄與錯誤案例回報.md)；以下 v21 數值與版本屬歷史基準，原品質 findings 與付費回歸暫停持續有效。
