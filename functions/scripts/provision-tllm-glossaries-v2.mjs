...
for (const [id, source, target, file] of [
  ["trade-zh-en-v2", "zh-TW", "en", "zh-en-v2.tsv"],
  ["trade-en-zh-v2", "en", "zh-TW", "en-zh-v2.tsv"],
]) {
  const name = parent + "/glossaries/" + id;
  const inputUri = "gs://" + project + "-translation-glossaries/v2/" + file;
...
await writeFile(new URL("../../.local/tllm-evaluation/glossaries-v2.json", import.meta.url),
