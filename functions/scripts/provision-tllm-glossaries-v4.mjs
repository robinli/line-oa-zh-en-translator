...
for (const [id, source, target, file] of [
  ["trade-zh-en-v4", "zh-TW", "en", "zh-en-v4.tsv"],
  ["trade-en-zh-v4", "en", "zh-TW", "en-zh-v4.tsv"],
]) {
  const name = parent + "/glossaries/" + id;
  const inputUri = "gs://" + project + "-translation-glossaries/v4/" + file;
...
await writeFile(new URL("../../.local/tllm-evaluation/glossaries-v4.json", import.meta.url),
