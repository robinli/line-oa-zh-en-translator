...
for (const [id, source, target, file] of [
  ["trade-zh-en-v5", "zh-TW", "en", "zh-en-v5.tsv"],
  ["trade-en-zh-v5", "en", "zh-TW", "en-zh-v5.tsv"],
]) {
  const name = parent + "/glossaries/" + id;
  const inputUri = "gs://" + project + "-translation-glossaries/v5/" + file;
...
await writeFile(new URL("../../.local/tllm-evaluation/glossaries-v5.json", import.meta.url),
