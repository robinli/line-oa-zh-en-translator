...
for (const [id, source, target, file] of [
  ["trade-zh-en-v6", "zh-TW", "en", "zh-en-v6.tsv"],
  ["trade-en-zh-v6", "en", "zh-TW", "en-zh-v6.tsv"],
]) {
  const name = parent + "/glossaries/" + id;
  const inputUri = "gs://" + project + "-translation-glossaries/v6/" + file;
...
await writeFile(new URL("../../.local/tllm-evaluation/glossaries-v6.json", import.meta.url),
