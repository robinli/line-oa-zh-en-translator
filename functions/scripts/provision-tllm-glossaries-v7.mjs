...
for (const [id, source, target, file] of [
  ["trade-zh-en-v7", "zh-TW", "en", "zh-en-v7.tsv"],
  ["trade-en-zh-v7", "en", "zh-TW", "en-zh-v7.tsv"],
]) {
  const name = parent + "/glossaries/" + id;
  const inputUri = "gs://" + project + "-translation-glossaries/v7/" + file;
...
await writeFile(new URL("../../.local/tllm-evaluation/glossaries-v7.json", import.meta.url),
