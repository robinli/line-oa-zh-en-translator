...
for (const [id, source, target, file] of [
  ["trade-zh-en-v8", "zh-TW", "en", "zh-en-v8.tsv"],
  ["trade-en-zh-v8", "en", "zh-TW", "en-zh-v8.tsv"],
]) {
  const name = parent + "/glossaries/" + id;
  const inputUri = "gs://" + project + "-translation-glossaries/v8/" + file;
...
await writeFile(new URL("../../.local/tllm-evaluation/glossaries-v8.json", import.meta.url),
