...
for (const [id, source, target, file] of [
  ["trade-zh-en-v1", "zh-TW", "en", "zh-en-v1.tsv"],
  ["trade-en-zh-v1", "en", "zh-TW", "en-zh-v1.tsv"],
]) {
  const name = parent + "/glossaries/" + id;
  const inputUri = "gs://" + project + "-translation-glossaries/v1/" + file;
...
await writeFile(new URL("../../.local/tllm-evaluation/glossaries-v1.json", import.meta.url),
