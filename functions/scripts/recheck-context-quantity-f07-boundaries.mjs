...
writeFileSync(new URL('../../.local/tllm-context-quantity-f07/boundaries.json',import.meta.url),JSON.stringify({at:new Date().toISOString(),syntheticOnly:true,results},null,2).replace(/\n/g,'\r\n')+'\r\n');
